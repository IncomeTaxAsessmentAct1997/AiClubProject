...
const ResultsPage = ({ currentAnswer }) => {
    ...
    // Calculate agreement percentage based on user's answer
    const agreementPercentage = stats
        ? (currentAnswer === 'AI' ? stats.percentageAI : stats.percentageReal)
        : 0;
                ...
                <>
                    ...
                    >
                        ...
                        <div className="percentage-bars">
                            ...
                            <div className="bar-container">
                                <span className="bar-label">Real</span>
                                <div className="bar-track">
                                    <motion.div
                        ...
                        >
                            <strong>{agreementPercentage}%</strong> of users agreed with you!
                        </motion.p>
                    </motion.div>
